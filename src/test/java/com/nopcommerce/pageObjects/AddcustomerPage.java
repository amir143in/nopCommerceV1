...
public class AddcustomerPage {
	...
	@FindBy(xpath = "//span[@title='clear' and @class='k-icon k-clear-value k-i-close']")
	WebElement clearSelectedCustomerRoles;
	...
	public void deleteSelectedCustomerRole() {

	}

	public void setCustomerRole(String role) throws InterruptedException {
		//clearSelectedCustomerRoles.click();
		selectCustomerRolesInitial.click();
		//selectCustomerRolesInitial.clear();
		Thread.sleep(1000);
